...
Data and plots shown in Figures 2A, 5A-C, S3A-D and S12 can be generated by running the code in single_cell_analysis.R. Data shown in Figures S4, S6, S8 and S9 can be generated via the corresponding R Markdown files.  
